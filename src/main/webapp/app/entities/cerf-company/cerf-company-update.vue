  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterApp.cerfCompany.home.createOrEditLabel"
          data-cy="CerfCompanyCreateUpdateHeading"
          v-text="t$('jhipsterApp.cerfCompany.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterApp.cerfCompany.relType')" for="cerf-company-relType"></label>
            <input
              type="text"
              class="form-control"
              name="relType"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterApp.cerfCompany.cerf')" for="cerf-company-cerf"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterApp.cerfCompany.company')" for="cerf-company-company"></label>
