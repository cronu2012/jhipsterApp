...
import Cerf from './cerf.vue';
import CerfService from './cerf.service';
import AlertService from '@/shared/alert/alert.service';

type CerfComponentType = InstanceType<typeof Cerf>;
...
describe('Component Tests', () => {
  ...
  describe('Cerf Management Component', () => {
    ...
    let mountOptions: MountingOptions<CerfComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Cerf, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(cerfServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(cerfServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: CerfComponentType;

      beforeEach(async () => {
        const wrapper = shallowMount(Cerf, { global: mountOptions });
        comp = wrapper.vm;
        await comp.$nextTick();
        cerfServiceStub.retrieve.reset();
        cerfServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(cerfServiceStub.retrieve.called).toBeFalsy();
      });
