...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getMainTitle()).as("check mainTitle").isEqualTo(actual.getMainTitle()))
            ...
            .satisfies(e -> assertThat(e.getCreatedTime()).as("check createdTime").isEqualTo(actual.getCreatedTime()))
            .satisfies(e -> assertThat(e.getUpdatedTime()).as("check updatedTime").isEqualTo(actual.getUpdatedTime()))
